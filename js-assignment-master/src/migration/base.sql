...
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('News 1', 'Description for news 1', 1, null, null);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('News 2', 'Description for news 2', null, 1, null);
insert ignore into mydb.news (title, description, matchId, tourId, sportId) values ('News 3', 'Description for news 3', null, null, 1);
